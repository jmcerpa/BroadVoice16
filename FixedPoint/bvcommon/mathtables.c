...
/* pow2tab=max(min(round(2^Q.*2.^x),32767),-32768);               */
...
/* log2tab=max(min(round(2^Q.*log2(x)),32767),-32768);            */
...
/* Q=15;                                                 */
/* x=linspace(0, pi, N);                                 */
/* cosx=min(max(round((2^Q)*cos(x)),32767),-32768);      */
...
/* Qa=12;                                                                  */
/* z=round((2^Qa)*(x(2:N)-x(1:N-1))./(cos(x(2:N))-cos(x(1:N-1)))/(2*pi));  */
