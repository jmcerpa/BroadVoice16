            ...
            Word16   gexpm3)
{
   ...
   for (n = 0; n < VDIM; n++) {
      ...
      a1 = L_shl(a1, 3);        /* Q16 */
      *spb = round(a1);     /* update output of the noise feedback filter */
      a2 = L_deposit_h(s[n]);
      a2 = L_sub(a2, a0);
      a2 = L_sub(a2, a1);       /* Q16 */
      *qzir++ = round(L_shl(L_sub(a2,*ltfv++),gexpm3));
      ...
      *spa = round(a2); /* update short-term noise feedback filter memory */
                   ...
                   Word16 gain_exp)
{
   ...
   for (n = 0; n < VDIM; n++) {
      ...
      *fp4++ = round(L_sub(L_sub(v, *p_ltfv++), uq32));  
      // Q0
   }
