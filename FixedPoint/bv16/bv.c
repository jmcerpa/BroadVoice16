...
int   main(int argc, char **argv)
{
   ...
   if (enc){
#if G192BITSTREAM
      fprintf(stderr," BroadVoice16 Fixed-Point Encoder V1.2 with ITU-T G.192\n");
#else
      fprintf(stderr," BroadVoice16 Fixed-Point Encoder V1.2 with packed bit-stream\n");
#endif
...
#if G192BITSTREAM
      fprintf(stderr," BroadVoice16 Fixed-Point Decoder V1.2 with ITU-T G.192\n");
#else
      fprintf(stderr," BroadVoice16 Fixed-Point Decoder V1.2 with packed bit-stream\n");
#endif
